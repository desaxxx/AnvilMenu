...
public class AnvilManager_V1_21_R6 extends AnvilWrapper {
    ...
    /*
     * EntityHuman#gB()                             -> EntityHuman#getInventory()
    ...
    /*
     * EntityHuman#cl               -> EntityHuman#containerMenu [Container]
    ...
    void closeContainer(@NotNull Player p) {
        ...
        player.g.b(new PacketPlayOutCloseWindow(player.cl.l));
        player.s();
    }
